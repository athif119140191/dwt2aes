...
def sisip_pesan_logic(cover_img, pesan_terenkripsi_hex, nonce, selected_layer, selected_signal,
    ...
    Mengembalikan stego_image, nilai PSNR/Kategori, dan informasi video stego, serta path audio.
    """
    ...
    # Hitung PSNR dan Kategori
    nilai_psnr = calculate_psnr(full_img, stego_image)
    if nilai_psnr > 37: nilai_kategori = 'Excellent'
    elif nilai_psnr > 31: nilai_kategori = 'Good'
    elif nilai_psnr > 25: nilai_kategori = 'Fair'
    elif nilai_psnr > 20: nilai_kategori = 'Poor'
    else: nilai_kategori = 'Bad'
    ...
    print("-----------------------------")
    print(f"PSNR: {nilai_psnr:.2f} dB, Kategori: {nilai_kategori}\n")

    return (stego_image, nilai_psnr, nilai_kategori, output_video_path, 
